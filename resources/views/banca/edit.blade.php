...
@section('content')
<div class="card mt-5">
  <h2 class="card-header bg-primary text-white">Editar Professor/Banca</h2>
  <div class="card-body">
 
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a class="btn btn-primary btn-sm" href="{{ route('banca.index') }}"><i class="fa fa-arrow-left"></i> Retornar</a>
    </div>
 
    <form action="{{ route('banca.update', $banca->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
       <div class="mb-3">
