...
<div class="page-content">
    ...
    <div class="mb-4">
        <h1 class="display-5 fw-bold text-dark">
            <i class="fas fa-edit text-primary me-3"></i>Editar Professor/Banca
        </h1>
        <p class="text-secondary lead">Atualize os dados do membro da banca</p>
    </div>
    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            <form action="{{ route('banca.update', $banca->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="inputTitulacao"
                        required
                        value="{{ old('titulacao', $banca->titulacao) }}"
